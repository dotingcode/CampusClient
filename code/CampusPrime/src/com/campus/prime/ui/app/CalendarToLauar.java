...
public final class CalendarToLauar {
    ...
    private static String[] nStr2 = { "初", "十", "廿十", "卅十", "　" };
    ...
    public static String getSimpleLunar(String year, String month, String day)
    {
    ...
    public static void main(String[] args) {
        ...
        //        农历 【狗】贰零零陆 年 七月大初十 丙戌年丙申月甲子日
        //        农历 【虎】贰零壹零 年 六月小廿三 庚寅年癸未月乙酉日
        System.out.println(CalendarToLauar.getSimpleLunar("2005", "5", "14"));
    }
}